...
{
    private const string Root = "Assets/map/Level_02_InkSnowCourtyard";
    private const string ScenePath = "Assets/Scenes/Level_02_InkSnowCourtyard.unity";
    private const string BarrelRoot = Root + "/Animations/Barrel";
    private const string ChestRoot = Root + "/Animations/ChestSnow";
    ...
    private const string BarrelPrefabPath = Root + "/Prefabs/Prefab_BarrelBreakable.prefab";
    private const string ChestPrefabPath = Root + "/Prefabs/Prefab_ChestSnowBreakable.prefab";
    ...
    private static void CreatePrefab(string path, string objectName, RuntimeAnimatorController controller, Sprite idleSprite, Vector2 colliderSize)
    {
        ...
        Directory.CreateDirectory(Path.GetDirectoryName(path) ?? Root + "/Prefabs");
